...
">
    <div class="container external-news__container">
        ...
        <?php if ( $external_news_text ) { ?>
            <p class="external-news__text subtitle text-center mb-3 mt-1 mt-lg-2 mb-lg-2"><?php echo esc_html( $external_news_text ); ?></p>
        <?php } ?>
                ...
                foreach ( $external_news_list as $item ) {
                    ...
                    <div class="external-news__card external-news__card-<?php echo esc_html( $c ); ?>">
                        <a href="<?php echo esc_url( $item['link'] ); ?>"
                           class="external-news__card-link<?php echo $item['add_video'] && ! empty( $item['video'] ) ? ' external-news__card-link_type-video' : ''; ?>">
