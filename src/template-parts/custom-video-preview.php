...
<div class="video-preview js-video-preview-container">
    ...
    <div class="video-preview__controls">
        <button type="button" class="video-preview__btn video-preview__skip js-skip-preview"><?php esc_html_e( 'Skip', 'wp-rock' ); ?></button>
        <button type="button" class="video-preview__btn video-preview__play-stop js-play-stop-preview"></button>
        <button type="button" class="video-preview__btn video-preview__mute-unmute js-mute-unmute-preview"></button>
    </div>
